<template>
  <div class="w-full p-14">
    ...
    <form class="mt-12">
      ...
      <div class="mb-5">
        <vue-phone-number-input v-model="regPhone" />
      </div>
      <div class="mb-5">
      ...
      <div class="mb-5 flex gap-1">
        ...
        <div>
          <p class="text-sm text-gray-500">
            By accessing this Website, accessible from chatbox.com, you are agreeing to be bound by these Website Terms and Conditions of Use and agree that you are responsible for the agreement with any applicable local laws. If you disagree with any of these terms, you are prohibited from accessing this site. The materials contained in this Website are protected by copyright and trade mark law.
          </p>
        </div>
      </div>
      <div class="mb-5">
